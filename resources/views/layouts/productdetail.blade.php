...
<div class="productDetail">
    <div class="container">
        <form id="" action="{{ route('addtocart') }}" method="post">
            ...
            @if($variants->first())
            <input type="hidden" name="size_id" value="{{ $variants->sortBy(" price")->first()->size->id }}"
            
            id="sizeIdInput">
            <input type="hidden" name="color_id" value="{{ $variants->sortBy(" price")->first()->size->id }}"
            id="colorIdInput">
            @endif
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3 pd-price">
                                ...
                                @else
                                <h4 class="pd-price--text">{{ number_format($product->price) }} ₫</h4>
                                @endif
                            </div>
